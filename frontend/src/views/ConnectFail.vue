  ...
  <div class="relative w-screen h-screen overflow-hidden font-display text-slate-100 bg-[#020c1b]">
    ...
    <main class="relative z-10 flex flex-col items-center justify-center w-full h-full max-w-5xl mx-auto px-6 py-12 text-center">
      ...
      <div class="mb-10 scale-in relative">
        ...
        <div class="relative w-32 h-32 md:w-40 md:h-40 rounded-full bg-linear-to-br from-accent to-yellow-500 flex items-center justify-center shadow-[0_0_60px_-10px_rgba(251,191,36,0.6)] border-4 border-[#1e1b04]">
          <span class="material-symbols-outlined text-[#020c1b] text-[64px] md:text-[80px] font-bold">close</span>
        </div>
        <!-- Progress ring -->
      ...
      <div class="flex flex-col items-center gap-6 fade-up">
        ...
        <!-- Status Card -->
        <div class="mt-4 flex flex-col md:flex-row items-center gap-4 md:gap-8 bg-[#0a192f]/60 backdrop-blur-md border border-white/10 px-8 py-5 rounded-xl shadow-2xl">
        ...
        <div class="mt-10 flex flex-col items-center gap-4">
          <button @click="retry"
                  class="group relative flex items-center gap-3 bg-accent hover:bg-yellow-400 active:scale-95 transition-all duration-200 text-[#020c1b] font-bold text-lg md:text-xl px-10 py-4 rounded-full shadow-[0_0_30px_-5px_rgba(251,191,36,0.5)] overflow-hidden cursor-pointer">
